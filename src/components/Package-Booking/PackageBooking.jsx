...
const Booking = ({tour,price}) => {
    ...
    const handleClick =async e =>{
        ...
        try {
            ...
            const res = await fetch(`${BASE_URL}/packagebooking`,{
                method:"post",
                headers:{
    ...
    const makePayment = async() =>{
        ...
        return (
            <div className="booking1">
                <div className="booking_top1 d-flex align-items-center
                ...
                {/* ===== booking form start ===== */}
                <div className="booking_form1">
                    <h5>Information</h5>
                    <Form className="booking_info-form1" onSubmit={handleClick}>
                        <FormGroup>
